...
const CartItems = ({ item }: { item: IProduct }) => {
          ...
          <div className="flex justify-between items-center gap-3">
            <div className="flex gap-x-2 items-center">
              ...
              <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden">
                <button className="px-3 py-2 cursor-pointer hover:bg-gray-100 transition-colors duration-150 text-gray-700">
            ...
            <div>
              <button onClick={() => removeFromCart(item.id.toString())} className="flex items-center gap-1 cursor-pointer">
